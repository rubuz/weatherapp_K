      ...
      <div className="mx-auto my-4 flex w-[95%] flex-col items-center justify-center rounded-3xl bg-light-violet p-4 shadow-md sm:w-[450px]">
        ...
        <div className="w-full">
          {cities.map((city, index) => (
            <div className="mb-1 rounded-lg bg-violet shadow-md transition-all duration-100 first-of-type:mt-4 first-of-type:rounded-t-2xl last-of-type:mb-0 last-of-type:rounded-b-2xl hover:scale-[101%] hover:cursor-pointer hover:ring-2 hover:ring-white2 active:scale-95">
              <CityCard
                key={index}
